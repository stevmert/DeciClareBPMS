...
public class ActivityAvailabilitySchedule extends ExistenceConstraint implements Negatable {
	...
	public static ActivityAvailabilitySchedule parseConstraint(String input, ParsingCache pc, Decision activationDec, Decision deactivationDecision, boolean isOptional) {
		throw new UnsupportedOperationException();
	}
}