...
public class AlternatePrecedence extends RelationConstraint implements TimedConstraint {
	...
	public static AlternatePrecedence parseConstraint(String input, ParsingCache pc, Decision activationDec, Decision deactivationDecision, boolean isOptional) {
		throw new UnsupportedOperationException();
	}
}