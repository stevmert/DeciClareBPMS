...
public abstract class DataAttribute implements DataStructure, Serializable, Comparable<DataAttribute> {
	...
	public int compareTo(DataAttribute other) {
		if(this.getParent() != null
			...
			return this.getParent().getName().compareTo(other.getParent().getName());
