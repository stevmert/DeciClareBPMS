...
public class HierarchicalKMeansInt extends KMeansIntImpl {
	...
	public static void main(String[] args) throws Exception {
		...
		HierarchicalKMeansInt k = new HierarchicalKMeansInt(true);
	...
	public HierarchicalKMeansInt(boolean showMessages) {
		super(showMessages);
	}
	...
	public Cluster[] run(ArrayList<ClusterPoint> cps, Activity[] activitiesInScope,
			...
			int nrOfRetries) {
		int iteration = 1;
		KMeansInt kmeans = new KMeansInt(isShowMessages());
