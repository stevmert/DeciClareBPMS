...
public class Cluster {
	...
	public void calculateCentroid() {
		...
		if(getClusterPoints().isEmpty())
			centroid = Profile.getRandomProfile(activitiesInScope, dataAttributesInScope);
		else
			centroid = new Profile(getClusterPoints(), activitiesInScope, dataAttributesInScope);
	}
