...
public class KMeansInt extends KMeansIntImpl {
	...
	public static void main(String[] args) throws Exception {
		...
		KMeansInt k = new KMeansInt(true);
	...
	public KMeansInt(boolean showMessages) {
		super(showMessages);
	}
	...
	public Cluster[] run(ArrayList<ClusterPoint> cps, Cluster[] clusters,
		...
		while(!finish) {
			...
			Profile[] lastCentroids = getCentroids(clusters);
			...
			Profile[] currentCentroids = getCentroids(clusters);
	...
	private static Profile[] getCentroids(Cluster[] clusters) {
		Profile[] centroids = new Profile[clusters.length];
