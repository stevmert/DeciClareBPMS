 ...
 */
public class ActivityEvent extends Activity implements Serializable {
	...
	public ActivityEvent(String name, long time) {
		super(name);
		if(name == null
				|| time < 0)
	...
	public int compareTo(Activity other) {
		if(other instanceof ActivityEvent) {
			ActivityEvent otherEvent = (ActivityEvent) other;
